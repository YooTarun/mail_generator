...
class EmailPromptGenerator(PromptGenerator):
    ...
    @staticmethod
    def email_messages(email_prompt):
        """
...
class IntentPromptGenerator(PromptGenerator):
    ...
    def generate_intent_prompt_template(self):
        """
        ...
        """
        return super().generate_intent_prompt(self.user_message, self.last_visited_websites)

    @staticmethod
    def intent_messages(intent_prompt):
        """
