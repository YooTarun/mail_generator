class PromptGenerator:
    @staticmethod
    def generate_intent_prompt(message, last_pages_websites):
        """
    ...
    @staticmethod
    def generate_email_prompt(last_visited_pages, user_name, user_message, intent_class, intent_class_reason, example_email):
        """
